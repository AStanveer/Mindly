   ...
   if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
    ...
    if ($result->num_rows === 1) {
        ...
        if (password_verify($password, $user['password_hash'])) {
            ...
            $mail = new Mail();
            $mail->setFrom("no-reply@mindly.it.com", "Mindly");
            $mail->setSubject("Your Login OTP Code - Expires in 5 Minutes");
            $mail->addTo($email);
            $mail->addContent( "text/html", "<p>Hello,</p><p>Your OTP code is <strong>$otp</strong>.</p><p>This code will expire in <strong>5 minutes</strong>.</p><p>If you did not request this, please ignore this email.</p><p>— Mindly Team</p>"
);
